...
\documentclass[a4paper, 10pt, twocolumn]{article}[22.2.2020]
...
\medskip
\begin{quotation}
{\fontfamily{pag}\selectfont Čím více druhů, }\textsc{řezů, }{\tiny velikostí}, barev písma \underline{a~jiných efektů} použijeme, tím {\emph{\large profesionálněji}} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen}!
\end{quotation}
\medskip
